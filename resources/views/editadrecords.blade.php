                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><select name="adAddress_ZoneID" >
                            ...
                            {{-- Changes selected option to the corresponding Hospital Type--}}
                            <option value="{{ $rzone->rzID }}" {{ $selectedrz == $rzone->rzID ? 'selected' : '' }}>{{ $rzone->rzID }}: {{ $rzone->rzTitle }}</option>
                            @endforeach
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><input size="20" type="text" name="adDepartmentID" value="{{$record->dpTitle}}"></td>
                    </tr>
                </table>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><select name="adDischargeTypeID" >
                        ...
                        {{-- Changes selected option to the corresponding Hospital Type--}}
                        <option value="{{ $dType->sxIMPS_ID }}" {{ $selectedDT == $dType->dtID ? 'selected' : '' }}>{{ $dType->dtID }}: {{ $dType->dtTitle }}</option>
                        @endforeach
                    </select></td>
                </tr>
                <tr>
